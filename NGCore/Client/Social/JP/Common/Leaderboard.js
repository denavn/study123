...
var Leaderboard = {
	...
	getLeaderboard: function(leaderboardId, fields, callback){
		...
		this._sendWriteCommand("JP.Leaderboard.getLeaderboard", data, callback);
	},
	 ...
	 * @public
	 *
	 * @param {String[]} leaderboardIds The leaderboard IDs of the leaderboards to retrieve.  This is provided as a
	 *	  comma separated string of leaderboard IDs.
	 * @param {String[]} fields Additional fields to retrieve. For a complete list of available
	 *		fields, see the properties of the callback function's <code>Leaderboard</code> parameter. The
	 *		required properties of the <code>Leaderboard</code> parameter are retrieved by default.
	...
	getLeaderboards: function(leaderboardIds, fields, callback){
		...
		this._sendWriteCommand("JP.Leaderboard.getLeaderboards", data, callback);
	},
	...
	getAllLeaderboards: function(fields, callback){
		...
		this._sendWriteCommand("JP.Leaderboard.getAllLeaderboards", data, callback);
	},
	...
	getTopScoresList: function(leaderboardId, fields, opts, callback){
		var options = {
			startIndex: (opts && opts.startIndex) ? opts.startIndex : null,
			count:	  (opts && opts.count)	  ? opts.count	  : null
		};
		var data = {
			leaderboardId: leaderboardId,
			fields: fields,
		...
		this._sendWriteCommand("JP.Leaderboard.getTopScoresList", data, callback);
	},
	...
	getFriendsScoresList: function(leaderboardId, userId, fields, opts, callback){
		...
		this._sendWriteCommand("JP.Leaderboard.getFriendsScoresList", data, callback);
	},
	...
	getScore: function(leaderboardId, userId, fields, callback){
		...
		this._sendWriteCommand("JP.Leaderboard.getScore", data, callback);
	},
	...
	updateCurrentUserScore: function(leaderboardId, value, callback){
		...
		this._sendWriteCommand("JP.Leaderboard.updateCurrentUserScore", data, callback);
	},
	...
	deleteCurrentUserScore: function(leaderboardId, callback){
		...
		this._sendWriteCommand("JP.Leaderboard.deleteCurrentUserScore", data, callback);
	},
	...
	_sendWriteCommand: function(apiURL, data, callback) {
		...
		NgLogD("_sendWriteCommand: " + JSON.stringify(cmd));
