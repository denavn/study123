...
exports.DebugMenuPage = Class.subclass(
{
    initialize: function (screen, param, changePage)
    {
        ...
        this._width = ScreenManager.width;
        this._height = ScreenManager.height;
    },
    destroy: function ()
    {
        var i;
    ...
    showMenu: function ()
    {
        ...
        contentFrame.inset((this._width/320)*25,5,5,5);
        var self = this;

        var crossBtnsize = [(this._width/320)*40, (this._width/320)*40]
        crossBtnposX = ((this._width - crossBtnsize[0]) - (this._width/320)*10);
        crossBtnposY = ((this._height/480)*10);
        var closeButton = new Button(this._baseDesign(
        {
            frame: [crossBtnposX, crossBtnposY, crossBtnsize[0], crossBtnsize[1]],
            text: "X",
            textSize: 16,
