...
/**
    ...
    */
     ...
     * @function
     */
    setImage: function ($super, imageURL, flags, imageSize, uvs)
    {
    ...
    */
     ...
     * @function
     */
    setRightImage: function (imageURL, flags, imageSize, uvs)
    {
        if (this._rightImage === null || this._rightImage === undefined)
        {
            this._makeRightImage();
        }
        this._rightImage.setImage(imageURL, flags, imageSize, uvs);
        this._renderView();
        return this;
    },
    /**
