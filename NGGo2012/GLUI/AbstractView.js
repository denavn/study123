...
exports.AbstractView = Element.subclass( /** @lends GLUI.AbstractView.prototype */
{
    ...
    initialize: function ($super)
    {
        ...
        this._clickDownCallback = null;
        this._clickCancelCallback = null;
    ...
    /**
     * @name GLUI.AbstractView#setOnClickDown
     * @description Set a function to call when the setOnClickDown event occurs.
     * @param {Function} clickDownCallback The new callback function. <br><br><b>Note:</b> The callback is set to empty if the value of this parameter is not a function.
     * @example button.setOnClickDown(function() { console.log("setOnClickDown event occurred");});
     * @see GLUI.AbstractView#event:getOnClickDown
     * @event
     */
    setOnClickDown: function (clickDownCallback)
    {
        if(typeof (clickDownCallback) !== "function")
        {
            if(clickDownCallback === "undefined" || clickDownCallback === null)
            {
                clickDownCallback = function ()
                {};
            }
            else
            {
                throw new Error(this.classname + " setOnClickDown expects (), (null), (function) but received " + clickDownCallback.type);
            }
        }
        this._clickDownCallback = clickDownCallback;
    },
    /**
     * @name GLUI.AbstractView#getOnClickDown
     * @description Retrieve a function to call when the setOnClickDown event occurs.
     * @returns {Function} The current callback function.
     * @see GLUI.AbstractView#event:setOnClickDown
     * @event
     */
    getOnClickDown: function ()
    {
        return this._clickDownCallback;
    },
    /**
     * @name GLUI.AbstractView#setOnClickCancel
     * @description Set a function to call when the setOnClickCancel event occurs.
     * @param {Function} clickCancelCallback The new callback function. <br><br><b>Note:</b> The callback is set to empty if the value of this parameter is not a function.
     * @example button.setOnClickCancel(function() { console.log("setOnClickCancel event occurred");});
     * @see GLUI.AbstractView#event:getOnClickCancel
     * @event
     */
    setOnClickCancel: function (clickCancelCallback)
    {
        if(typeof (clickCancelCallback) !== "function")
        {
            if(clickCancelCallback === "undefined" || clickCancelCallback === null)
            {
            ...
            {
                throw new Error(this.classname + " setOnClickCancel expects (), (null), (function) but received " + clickCancelCallback.type);
            }
        }
        this._clickCancelCallback = clickCancelCallback;
    },
    /**
     * @name GLUI.AbstractView#getOnClickCancel
     * @description Retrieve a function to call when the setOnClickCancel event occurs.
     * @returns {Function} The current callback function.
     * @see GLUI.AbstractView#event:setOnClickCancel
     * @event
     */
    getOnClickCancel: function ()
    {
        return this._clickCancelCallback;
    },
    /**
     * Set view state.
     * @function
    ...
    _touchReceivedCallBack: function (touch, isDelegating)
    {
        ...
        case touch.Action.Start:
            if(!this._isHandlingTouch && (this._clickCallBack || this._longPressCallBack || this._swipeCallback || this._clickDownCallback || this._clickCancelCallback) && this._isTouchInFrame(touch) && this._enabled && this._visible && this._parentEnabled && this._parentVisible && !(this.getState() & Commands.State.Disabled) && this._clickable && this._touchable && this._parentTouchable)
            {
                ...
                if(this._clickDownCallback)
                {
                    this._clickDownCallback();
                    if(this._exist && (this._isTouchInFrame(touch) === null || !this._enabled || !this._visible || !this._parentEnabled || !this._parentVisible || (this.getState() & Commands.State.Disabled) || !this._touchable || !this._parentTouchable))
                    {
                        if(this._longPressCBTimeoutID)
                        {
                            clearTimeout(this._longPressCBTimeoutID);
        ...
        case touch.Action.End:
            ...
            else if(!this._hasMovedOutside && this._clickCancelCallback)
            {
                this._clickCancelCallback();
            }
            this._isPressed = false;
            this._hasMovedOutside = false;
            if(this._longPressCBTimeoutID)
