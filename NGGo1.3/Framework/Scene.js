 ...
 * <li><code>{@link Framework.Scene.Transitions}: Transitions module.</li>
 */
exports.Scene = {};
...
exports.Framework.__defineGetter__("Transitions", function ()
{
    delete this.Transitions;
    this.Transitions = require('./Scene/Transitions').Transitions;
